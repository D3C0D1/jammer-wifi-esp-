...
const char CLI_INFO_SOFTWARE[] PROGMEM = " ESCANER Y DEAUTENTICADOR";
const char CLI_INFO_COPYRIGHT[] PROGMEM = "2023 (c) D3C0D1";
const char CLI_INFO_LICENSE[] PROGMEM = "Este software tiene licencia MIT ";
const char CLI_INFO_ADDON[] PROGMEM = "D3C0D1";
const char CLI_DEAUTHING[] PROGMEM = "Deautenticando..";
const char CLI_ARROW[] PROGMEM = " -> ";
const char CLI_SENDING_BEACON[] PROGMEM = "Enviando señal \"";
const char CLI_SENDING_PROBE[] PROGMEM = "Enviando prueba  \"";
const char CLI_CUSTOM_SENT[] PROGMEM = "Enviar paquete customizador";
